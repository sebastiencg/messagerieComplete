...
Profile
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['relation:read-one','profile:read-all','profile:read-one','relation:read-onlyRelation','groups'=>'groupe:read-onlyGroupe','privateMessage:read-message','conversation:read-conversation','group:read-all','GroupMessage:read-message','responseMessage:read-response','responseMessage:all-response','community:read-all','communityMessage:read-message'])]
    private ?int $id = null;
    ...
    #[Groups(['relation:read-one','profile:read-one','profile:read-all','relation:read-onlyRelation','groups'=>'groupe:read-onlyGroupe','privateMessage:read-message','conversation:read-conversation','group:read-all','GroupMessage:read-message','responseMessage:read-response','responseMessage:all-response','community:read-all','communityMessage:read-message'])]
